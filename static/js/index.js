$(document).ready(function(){
    ...
    let input_data = ""
    let product = ""
    let emotion = "negative, neutral, positive"
    let emoji_url = "./static/assets/emoticons/negative.png"
    ...
    $('').click(function(){
        ...
        //  input data 
        input_data = {'date' : 2023 , 'product' : product , 'review' : review , 'sentiment' : emotion}

        //  ajax call
        $.ajax({
            type : '',
            url : './static/assets/emoticons/negative.png',
            data : JSON.stringify(input_data),
            dataType : 'json',
            contentType : 'application/json',
            success : function(result){
